...
# ============ КРЫЛО: шаблон ============
def wing_page(slug,img,sci_img,cap,ew,title,lead,intro,states,progs,bullets,cls,labels,quote,fact):
...
''' % (phero(img,ew,title,lead,title,labels), intro[0], twocol, mq, fb,
       ecls, st, ecls, progs, sci_img, cap, ecls, ecls, bl,
...
sess='''
%s
<section><div class="wrap"><div class="prose" style="max-width:880px"><p class="lead">Программы это маршрут для всех. Сессия и сопровождение это работа лично с тобой: с твоим состоянием, твоими решениями, твоим телом.</p>
<p>Здесь Дарья работает один на один. Не разговор о проблемах вокруг да около, а работа с корнем: находим, где держит, и меняем изнутри. Многие получают результат уже за одну встречу.</p></div></div></section>
<section class="soft"><div class="wrap"><div class="sec-h"><span class="eyebrow">Форматы</span><h2>Личная работа с Дарьей</h2><p>Два формата под разную глубину: одна точная встреча или месяц рядом.</p></div>
<div class="duo">
<div class="person"><div class="pav" style="background:linear-gradient(145deg,#2f6bff,#221a5e)">1:1</div><h3>Персональная сессия</h3><div class="role">60-90 минут · один на один</div><p>Одна встреча с корнем запроса. Разбираем, что держит на месте, и находим решение, которое ты когда-то принял и забыл. Запись остаётся у тебя.</p><div class="book-buy"><span class="price">12 500 ₽</span><a class="btn primary bracket" href="%ssession1/" target="_blank" rel="noopener">Записаться</a></div></div>
<div class="person d"><div class="pav">VIP</div><h3>VIP-сопровождение</h3><div class="role">1 месяц · максимальная глубина</div><p>Месяц личной работы с Дарьей: с твоим мозгом, паттернами и телом. Для тех, кто хочет максимальный результат в короткий срок. Доступ к материалам остаётся навсегда.</p><div class="book-buy"><a class="btn primary bracket" href="%sshop/" target="_blank" rel="noopener">Узнать о VIP</a></div></div>
</div></div></section>
<section><div class="wrap"><div class="sec-h"><span class="eyebrow">Как проходит</span><h2>Что тебя ждёт</h2></div>
<ul class="thm-list" style="max-width:820px">%s%s%s</ul></div></section>
%s
''' % (phero('img/sessions-1.jpg','Личная работа','Сессии и сопровождение','Работа один на один с Дарьей. С твоим состоянием, решениями и телом. Не разговоры вокруг, а работа с корнем.','Сессии'),
       U, U,
       bullet('<b>Работа с корнем</b>, а не с симптомом: находим, где именно держит, и меняем это.','dna'),
       bullet('<b>Результат за встречу</b>: многие получают сдвиг уже после первой сессии.','grow'),
       bullet('<b>Запись остаётся</b>: возвращаешься к сессии, когда нужно закрепить.','clock'),
       cta_band('Готов к личной работе','Напиши, и подберём формат под твой запрос: одна сессия или месяц сопровождения.','Написать в поддержку','https://t.me/TheBodyMindCode_support'))
page('sessions','Сессии и сопровождение — Архитектура сознания',sess,'Личная работа с Дарьей: персональная сессия 1:1 и VIP-сопровождение на месяц.',active='sessions')
