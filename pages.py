...
# ============ КРЫЛО: шаблон ============
def wing_page(slug,img,sci_img,cap,ew,title,lead,intro,states,progs,bullets,cls):
    ...
    intro_html=('<p class="lead">%s</p>'%intro[0])+''.join('<p>%s</p>'%p for p in intro[1:])
    body='''
%s
<section><div class="wrap"><div class="prose" style="max-width:880px">%s</div></div></section>
...
%s
''' % (phero(img,ew,title,lead,title), intro_html,
