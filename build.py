...
'</div></div>'
'<div class="pers"><div class="nm">Алексей</div><div class="rl">Структура, наука, проверка</div>'
'<div class="sbtns">'
...
'</div></div>'
'<a class="fsupport" href="https://t.me/TheBodyMindCode_support" target="_blank" rel="noopener">Написать в поддержку</a>'
'</div>'
'</div>'
'<div class="bot"><span>© 2026 «Архитектура сознания». Все права защищены.</span>'
'<span>Дарья Ростовцева и Алексей</span></div>'
'</div></footer>')
