...
'<a href="o-nas.html">О нас</a><a href="daria.html">Дарья Ростовцева</a><a href="kontakty.html">Контакты</a></div></div>'
'<div class="fppl">'
...
# ---------- досье: три статьи-лидмагнита ----------
DOSSIER=[
 ('https://thebodymindcode.github.io/peace/','img/dos-peace.jpg','brain','Мозг и DMN','14 мин',
 ...
 ('https://thebodymindcode.github.io/body/','img/dos-body.jpg','body','Нейробиология','18 мин',
 ...
 ('https://thebodymindcode.github.io/moneyprotocol/','img/dos-money.jpg','money','Нейробиология денег','15 мин',
...
def dossier_section(soft=False):
    ...
    for url,cov,cls,tag,rt,title,hook in DOSSIER:
        cards+=('<a class="dcard" href="%s" target="_blank" rel="noopener">'
          '<div class="dcov"><img src="%s" alt="" loading="lazy"><span class="dtag %s">%s</span></div>'
    ...
    return ('<section class="dossier%s"><div class="wrap"><div class="sec-h"><span class="eyebrow">Досье</span>'
      '<h2>С этого стоит начать</h2><p>Три глубоких разбора, которые обычно открывают людям глаза. Собрано то, о чём не говорят на приёме и не преподают в вузе. Каждое ведёт к своей программе.</p></div>'
